const CACHE_NAME = "rondreis-noorwegen-2026-v70-photo-date-groups";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260726-photo-date-groups",
  "./app.js?v=20260726-photo-date-groups",
  "./manifest.webmanifest",
  "./data/stages.js?v=20260726-photo-date-groups",
