const CACHE_NAME = "rondreis-noorwegen-2026-v78-panorama-mark-fix";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260728-panorama-mark-fix",
  "./app.js?v=20260728-panorama-mark-fix",
  "./manifest.webmanifest",
  "./data/stages.js?v=20260728-panorama-mark-fix",
