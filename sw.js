const CACHE_NAME = "rondreis-noorwegen-2026-v79-photo-date-delete";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260728-photo-date-delete",
  "./app.js?v=20260728-photo-date-delete",
  "./manifest.webmanifest",
  "./data/stages.js?v=20260728-photo-date-delete",
